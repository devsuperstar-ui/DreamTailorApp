...
4. **\`"experience"\` bullets** — every **required** JD keyword plus **JD industry/domain terms** (when present) appear at least once, framed credibly per employer/dates. **Each bullet MUST be 34–40 words** (hard minimum 34). Short bullets (~20 words) fail ATS depth — expand with stack, scope, stakeholders, and outcome.
...
- [ ] **Every experience bullet is 34–40 words** (count words; expand any under 34)
