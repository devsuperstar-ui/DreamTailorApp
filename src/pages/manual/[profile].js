...
const ManualProfileGeneratorView = dynamic(
  () => import("@/components/profile/ManualProfileGeneratorView"),
...
export default function ManualProfilePage() {
  ...
  if (isBootstrapping) {
    return (
      <>
        <Head>
          <title>Manual Resume Generator</title>
